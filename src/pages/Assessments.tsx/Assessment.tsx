...
const Assessment = () => {
    ...
    return (
        <div className={classNames('md:ml-28 lg:pl-8 lg:ml-0  duration-200 p-2 my-3 w-full md:relative  lg:top-10   ', showOverViewInMobile ? 'translate-y-[0]' : '-translate-y-[20%] md:-translate-y-[18%] lg:translate-y-0 ')} >
