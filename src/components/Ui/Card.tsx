...
const Card = ({ MainIcon, title, subTitle, date, handleClick, Duration, Question, BadgeArray, resolution }: ICard) => {
    const color = ['AccentBlue', 'AccentGreen', 'AccentRed']
    return (
        <section className='font-font-inter  font-medium  justify-center
          max-w-[450px] min-w-[420px]  md:min-w-[450px] min-h-[200px] flex flex-col xl:gap-5 gap-3  p-2  xl:p-4 border text-primaryText  border-primaryBorder hover:bg-primaryBackground
         rounded-xl'>
